...
Config.Items = {
    { name = "clay",       label = "Clay",         chance = 20, amount = 3 },
    { name = "coal",       label = "Coal",         chance = 14, amount = 3 },
    { name = "copper",     label = "Copper",       chance = 10, amount = 2 },
    { name = "iron",       label = "Iron",         chance = 20, amount = 2 },
    { name = "nitrite",    label = "Nitrite",      chance = 5,  amount = 2 },
    { name = "rock",       label = "Rocks",        chance = 10, amount = 3 },
    { name = "salt",       label = "Salt",         chance = 10, amount = 3 },
    { name = "goldnugget", label = "Gold Nuggets", chance = 5,  amount = 2 },
}
